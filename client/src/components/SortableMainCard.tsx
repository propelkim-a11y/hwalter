...
export function SortableMainCard({ cardId, label, order, visible, onMove, onDragStateChange, children }: SortableMainCardProps) {
  ...
  return (
    ...
    >
      {isDropTarget && (
        <div className="pointer-events-none absolute -top-3 left-1/2 z-40 -translate-x-1/2 rounded-full px-2.5 py-1 text-xs font-bold shadow-sm" style={{ background: "#3D5A3E", color: "#fff" }}>
          여기에 놓기
        </div>
      )}
