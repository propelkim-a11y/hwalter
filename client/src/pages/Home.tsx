            ...
            <div className="px-4 pb-4">
              ...
              {myLat && myLng ? (
                <div className="space-y-2">
                  {[...clubs]
                    .map((c) => ({ ...c, dist: haversineKm(myLat!, myLng!, c.latitude, c.longitude) * 1000 }))
                    ...
                    .map((c, idx) => {
                      ...
                      return (
                        ...
                        >
                          ...
                          <span className="text-sm font-bold flex-shrink-0 ml-2" style={{ color: inside ? "#3D5A3E" : "#6B7280" }}>{distLabel}</span>
                        </button>
                      );
                    })}
                </div>
                      ...
                      {filtered.map((club) => (
                        ...
                        >
                          ...
                          <button
                            ...
                            className="ml-3 flex-shrink-0 px-3 py-1 rounded-lg text-xs font-bold transition-all active:scale-95"
                            style={{
